      ...
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
        ...
        <SectionHeader
          headerInfo={{
            ...
            description: `Our service allows you to remotely manage and access your data anytime, from anywhere. Enjoy seamless control, secure storage, and real-time updates, ensuring efficiency and flexibility for your business needs.`,
          }}
        />
