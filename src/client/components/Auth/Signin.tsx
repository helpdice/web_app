...
const Signin = () => {
  return (
    <>
      {/* <!-- ===== SignIn Form Start ===== --> pb-12.5 pt-32.5 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50 */}
      <section className="">
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          >
            <h2 className="mb-15 text-center text-xl font-semibold text-black dark:text-white"> {/* xl:text-sectiontitle2 */}
                ...
                <button
                  onClick={async () => await Auth.signInWithGoogle({
                    onSuccess(res: any) {
                      ...
                      Auth.saveTokenToStorage(res.data.token);
                      Auth.saveTokenToCookie(res.data.token);
                    },
                    onError: (error: any) => {
                      console.log(error);
            ...
            <FormWrapper
              ...
              onSubmit={function (
                ...
                //       Auth.saveTokenToStorage(response.data.token);
                //       Auth.saveTokenToCookie(response.data.token);
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                      <input
                        ...
                        className="w-full border-b border-stroke !bg-white pb-1 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:!bg-black dark:focus:border-manatee dark:focus:placeholder:text-white lg:w-1/2"
                      />
