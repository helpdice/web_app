    ...
    <>
      <div className="mt-11 flex flex-wrap gap-4 md:items-center md:justify-between md:gap-0">
        <ul className="flex items-center gap-6">
          ...
          <li>
            <button 
            onClick={() => shareUrl(title, url).facebook()} 
            className="cursor-pointer" aria-label="social link">
              <svg
          ...
          <li>
            <button 
            // onClick={() => shareUrl(title, url).twitter()} 
            className="cursor-pointer" aria-label="social link">
              <svg
                className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                width="24"
          ...
          <li>
            <button 
            onClick={() => shareUrl(title, url).linkedin()} 
            className="cursor-pointer" aria-label="social link">
              <svg
                className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                width="24"
