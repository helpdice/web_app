...
const ListItem = ({ text, className, children }: { text?: string, className?: string; children?: React.ReactNode }) => {
  return (
    <li className={`flex text-body-color dark:text-dark-600 ${className}`}>
      <span className="mr-2.5 mt-0.5 text-primary dark:text-gray-700">
        <svg
          width={20}
          height={20}
          viewBox="0 0 20 20"
