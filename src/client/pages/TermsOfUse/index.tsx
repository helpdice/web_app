...
export default function TermOfUse() {
  ...
  return (
    <>
      <Helmet>
        <title>{metaTags.termsOfUse.meta_title}</title>
        <meta name="description" content={metaTags.termsOfUse.meta_description} />
      </Helmet>
      <section className="py-20 lg:py-25 xl:py-30 px-15 lg:px-25 xl:px-30">
        <div className="default-border text-justify my-2 mx-1">
          <h1 className="dark:text-white">Terms Of Use</h1>
          <br />
          <div className="px-3 pt-3">
            <b>
              Welcome to <span>Helpdice.com!</span>
            </b>
            <p>
              These terms and conditions outline the rules and regulations for the
              use of Helpdice&apos;s Website, located at{' '}
              <span>https://*.helpdice.com/.</span>
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use helpdice.com if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing helpdice.com, you agreed to
              use cookies in agreement with the Helpdice&apos;s Privacy Policy.
            </p>
            <p>
            ...
            <p>
              Unless otherwise stated, Helpdice and/or its licensors own the
              intellectual property rights for all material on helpdice.com. All
              intellectual property rights are reserved. You may access this from
              helpdice.com for your own personal use subjected to restrictions set
            ...
            <ul className="list-unstyled">
              <li>Republish material from helpdice.com</li>
              <li>Sell, rent or sub-license material from helpdice.com</li>
              <li>Reproduce, duplicate or copy material from helpdice.com</li>
              <li>Redistribute content from helpdice.com</li>
              <li>This Agreement shall begin on the date hereof.</li>
            </ul>
            <p>
              Parts of this website offer an opportunity for users to post and
              exchange opinions and information in certain areas of the website.
              Helpdice does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views and
              opinions of Helpdice,its agents and/or affiliates. Comments reflect
              the views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, Helpdice shall
              not be liable for the Comments or for any liability, damages or
              expenses caused and/or suffered as a result of any use of and/or
              posting of and/or appearance of the Comments on this website.{' '}
            </p>
            <p>
              Helpdice reserves the right to monitor all Comments and to remove any
            ...
            <ul className="list-unstyled">
              ...
              <li>
                You hereby grant Helpdice a non-exclusive license to use, reproduce,
            ...
            <ul className="list-unstyled">
              ...
              <li>
                ...
                compensates the absence of Helpdice;
              </li>
              <li>
            ...
            <p>
              ...
              sending an e-mail to Helpdice. Please include your name, your
            ...
            <ul className="list-unstyled">
              ...
              <li>
                No use of Helpdice&apos;s logo or other artwork will be allowed for
