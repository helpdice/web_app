...
export default function ContactPage() {
  ...
  return (
    <section className="py-20 lg:py-25 xl:py-30 px-15 lg:px-25 xl:px-30" id="contact">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20 bg-blue-50 dark:bg-slate-800">
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">
              Get in touch with us for inquiries, support, or feedback. We’re here to assist you with any questions!
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2">
            <div className="h-full pr-6">
              <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                Reach out to us for expert support, product inquiries, or technical assistance. We provide innovative solutions tailored to meet your needs in the tech industry. Let’s connect and enhance your experience.
              </p>
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Bhattakufer Road, Sanjauli, Shimla</p>
                    <p className="text-gray-600 dark:text-slate-400">Himachal Pradesh, India</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                ...
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Monday - Friday : 09:00 - 17:00</p>
                    <p className="text-gray-600 dark:text-slate-400">Saturday &amp; Sunday : 09:00 - 14:00</p>
                  </div>
                </li>
              </ul>
            </div>
